...
│   ├── full_zentao_cli.py              # 构建→推送→部署→验证 全链路
...
```bash
cd D:\testops_platfrom_deploy\pkg_deploy\zentao_cli
...
```bash
# 脚本文件
scp pkg_deploy/zentao/build/build_php.sh        root@192.168.0.102:/home/zendao/
scp pkg_deploy/zentao/build/build.sh            root@192.168.0.102:/home/zendao/
scp pkg_deploy/zentao/build/clean_php.sh        root@192.168.0.102:/home/zendao/
scp pkg_deploy/zentao/build/Dockerfile          root@192.168.0.102:/home/zendao/
scp pkg_deploy/zentao/build/Dockerfile.prebuilt root@192.168.0.102:/home/zendao/
scp pkg_deploy/zentao/build/docker-entrypoint.sh root@192.168.0.102:/home/zendao/
# 源码包
scp pkg_deploy/zentao/build/zentaopms.zip       root@192.168.0.102:/home/zendao/
# 编译依赖包（可选，不传则自动下载）
scp pkg_deploy/zentao/build/libzip-1.10.1.tar.gz root@192.168.0.102:/home/zendao/
scp pkg_deploy/zentao/build/onig-6.9.9.tar.gz   root@192.168.0.102:/home/zendao/
scp pkg_deploy/zentao/build/httpd-2.4.62.tar.gz root@192.168.0.102:/home/zendao/
scp pkg_deploy/zentao/build/php-8.1.27.tar.gz   root@192.168.0.102:/home/zendao/
# MySQL 安装文件
scp pkg_deploy/mysql8.0/install_mysql.sh         root@192.168.0.102:/home/zendao/
scp pkg_deploy/mysql8.0/uninstall_mysql.sh       root@192.168.0.102:/home/zendao/
```
...
```python
from pkg_deploy.zentao.verify.testcase_sync import ZentaoAPIClient
...
完整流水线脚本位于 `pkg_deploy/java_app_cicd/jenkins/Jenkinsfile`，包含 6 个 Stage：
