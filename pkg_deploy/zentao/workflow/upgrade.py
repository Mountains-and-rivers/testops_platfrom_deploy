...
def upgrade_zentao(version: str):
    ...
    rendered_path = os.path.join(CONFIG_DIR, "rendered", "zentao_cli.yaml")
    YAMLHelper.render_template(os.path.join(MANIFEST_DIR, "zentao_cli.yaml"), vars_dict, rendered_path)
